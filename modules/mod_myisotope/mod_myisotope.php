...
//data
$articles = modMyIsotopeHelper::getArticlesMI( $categories, $filter, $orderingtype, $ordering, $limit );
$categories = modMyIsotopeHelper::getCategoriesMI( $categories );

require JModuleHelper::getLayoutPath( 'mod_myisotope', $layout );
