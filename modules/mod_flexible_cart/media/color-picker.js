...
var ColorPicker = new Class({
    ...
    initialize: function(el,options){
        ...
        for ( var i=0; i< colorArray.length; i++)
 	    {
		  ...
		  for ( var j=0; j< colorArray.length; j++)
		  {
			  ...
			  for ( var k=0; k< colorArray.length; k++)
			  {
				   ...
				   currCell.addEvent('click', function(currColor,e){this.el.value = currColor; this.closePicker();}.bind(this, currColor));
				   currCell.addEvent('mouseover', function(currColor,e){ this.colorPanel.setStyle("backgroundColor", currColor);  this.infoPanel.innerHTML = currColor;	}.bind(this, currColor));
		...
		this.chartContainer.addEvent('mouseout', function(currColor, e){ try{this.colorPanel.setStyle("backgroundColor", this.el.value); } catch(e){} this.infoPanel.innerHTML = '';	}.bind(this, currColor));
