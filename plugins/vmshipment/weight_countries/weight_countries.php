...
class plgVmShipmentWeight_countries extends vmPSPlugin {
	...
	function getCosts (VirtueMartCart $cart, $method, $cart_prices) {
		...
		if ($method->free_shipment && $cart_prices['salesPrice'] >= $method->free_shipment) {
			 ...
			 *modification override by Atweb (shipment cost calculation by product quantity )
			 */
			
			//foreach ($cart->products as $product) {
			//return ($method->cost + $method->package_fee) * $product->quantity;
			...
			return ($method->cost + $method->package_fee) * $total;
