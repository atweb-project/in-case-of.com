...
class PlgSystemVmCloudZoom extends JPlugin{
	...
	function getAddImages(){
		...
		//Custom only for Werewolf Category by Atweb
		if($virtuemart_product_id == 19 || $virtuemart_product_id == 22){
			$main_image_url_thumb_i = JURI::base().$images[$i]->file_url_folder_thumb.$images[$i]->file_name.".".$images[$i]->file_extension;
			$seventhumb = JURI::base().$images[6]->file_url;
			
			$html .= "<div class=\"floatleft\"><a href='".JURI::base().$images[0]->file_url."' class='cloud-zoom-gallery' title='Thumbnail 1' rel=\"useZoom: 'zoom1', smallImage: '".JURI::base().$images[0]->file_url_folder_thumb.$images[0]->file_name.'.'.$images[0]->file_extension."' \"><img style=\"width:".$thumbimageWidth."px !important;height:".$thumbimageHeight."px !important;\" src='".JURI::base().$images[0]->file_url_thumb."' alt = \"Thumbnail 1\"/></a></div>";
			$html .= "<div class=\"floatleft\"><a href='".JURI::base().$images[1]->file_url."' class='cloud-zoom-gallery' title='Thumbnail 2' rel=\"useZoom: 'zoom1', smallImage: '".JURI::base().$images[1]->file_url_folder_thumb.$images[1]->file_name.'.'.$images[1]->file_extension."' \"><img style=\"width:".$thumbimageWidth."px !important;height:".$thumbimageHeight."px !important;\" src='".JURI::base().$images[1]->file_url_thumb."' alt = \"Thumbnail 2\"/></a></div>";
			$html .= "<div class=\"floatleft\"><a href='".JURI::base().$images[2]->file_url."' class='cloud-zoom-gallery' title='Thumbnail 3' rel=\"useZoom: 'zoom1', smallImage: '".JURI::base().$images[2]->file_url_folder_thumb.$images[2]->file_name.'.'.$images[2]->file_extension."' \"><img style=\"width:".$thumbimageWidth."px !important;height:".$thumbimageHeight."px !important;\" src='".JURI::base().$images[2]->file_url_thumb."' alt = \"Thumbnail 3\"/></a></div>";
			$html .= "<div class=\"floatleft usatext\">For USA: Muzzle of barrel<br>has BLAZE ORANGE PLUG<br>as required by US LAW</div>";
			$html .= "<div class=\"floatleft\"><a href='".JURI::base().$images[3]->file_url."' class='cloud-zoom-gallery' title='Thumbnail 4' rel=\"useZoom: 'zoom1', smallImage: '".JURI::base().$images[3]->file_url_folder_thumb.$images[3]->file_name.'.'.$images[3]->file_extension."' \"><img style=\"width:".$thumbimageWidth."px !important;height:".$thumbimageHeight."px !important;\" src='".JURI::base().$images[3]->file_url_thumb."' alt = \"Thumbnail 4\"/></a></div>";
			$html .= "<div class=\"floatleft\" style=\"float:none\"><a href='".JURI::base().$images[4]->file_url."' class='cloud-zoom-gallery' title='Thumbnail 5' rel=\"useZoom: 'zoom1', smallImage: '".JURI::base().$images[4]->file_url_folder_thumb.$images[4]->file_name.'.'.$images[4]->file_extension."' \"><img style=\"width:".$thumbimageWidth."px !important;height:".$thumbimageHeight."px !important;\" src='".JURI::base().$images[4]->file_url_thumb."' alt = \"Thumbnail 5\"/></a></div>";
			
			$html .= "<div class=\"floatleft\"><a href='".JURI::base().$images[5]->file_url."' class='cloud-zoom-gallery' title='Thumbnail 6' rel=\"useZoom: 'zoom1', smallImage: '".JURI::base().$images[5]->file_url_folder_thumb.$images[5]->file_name.'.'.$images[5]->file_extension."' \"><img style=\"width:".$thumbimageWidth."px !important;height:".$thumbimageHeight."px !important;\" src='".JURI::base().$images[5]->file_url_thumb."' alt = \"Thumbnail 6\"/></a></div>";
			if(!empty($images[6])){
			$html .= "<div class=\"floatleft\"><a href='".JURI::base().$images[6]->file_url."' class='cloud-zoom-gallery' title='Thumbnail 7' rel=\"useZoom: 'zoom1', smallImage: '".JURI::base().$images[6]->file_url_folder_thumb.$images[6]->file_name.'.'.$images[6]->file_extension."' \"><img style=\"width:".$thumbimageWidth."px !important;height:".$thumbimageHeight."px !important;\" src='".JURI::base().$images[6]->file_url_thumb."' alt = \"Thumbnail 7\"/></a></div>";
			}	
			if(!empty($images[7])){
				$html .= "<div class=\"floatleft\" ><a href='".JURI::base().$images[7]->file_url."' class='cloud-zoom-gallery' title='Thumbnail 8' rel=\"useZoom: 'zoom1', smallImage: '".JURI::base().$images[7]->file_url_folder_thumb.$images[7]->file_name.'.'.$images[7]->file_extension."' \"><img style=\"width:".$thumbimageWidth."px !important;height:".$thumbimageHeight."px !important;\" src='".JURI::base().$images[7]->file_url_thumb."' alt = \"Thumbnail 8\"/></a></div>";
			}
			$html .= "<div class=\"floatleft lighttext\">LED lighting add-on available only for Europe</div>";
			$html .= "</div>";
			$html .= "</div>";
		}
		else
		{	//continue in the original code		
		...
		$html .="<div class=\"floatleft lighttext\">LED lighting add-on available only for Europe</div>";	//Atweb addon
		$html .= "</div>";
		$html .= "</div>";
		}	
    return $html;
