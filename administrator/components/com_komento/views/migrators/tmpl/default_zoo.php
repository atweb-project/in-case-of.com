...
$zooObj = $componentHelper->getComponentObject( 'com_zoo' );
		...
		<td width="50%" valign="top">
			...
			<legend><?php echo JText::_( 'COM_KOMENTO_MIGRATORS_LAYOUT_MAIN' ); ?></legend>
				<table class="migrator-options admintable">
					<tr>
						<td class="key"><span><?php echo JText::_( 'COM_KOMENTO_MIGRATORS_ZOO_SELECT_CATEGORIES' ); ?></span></td>
...
<?php } else { ?>
<table id="migrator-zoo" class="noshow adminlist">
	<tr>
		<td><?php echo JText::_( 'COM_KOMENTO_ZOO_NOT_INSTALLED' ); ?></td>
	</tr>
</table>
<?php } ?>
