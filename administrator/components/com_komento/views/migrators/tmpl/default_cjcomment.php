...
if( $componentHelper->isInstalled( 'com_comment' ) ) {

$components	= $this->getModel()->getMigrator( 'cjcomment' )->getUniqueComponents();
$selection = array();
...
<table id="migrator-cjcomment" migrator-type="cjcomment" migration-type="component" class="noshow migratorTable">
	<tr>
...
<?php } else { ?>
<table id="migrator-cjcomment" class="noshow adminlist">
	<tr>
		<td><?php echo JText::_( 'COM_KOMENTO_CJCOMMENT_NOT_INSTALLED' ); ?></td>
	</tr>
</table>
<?php } ?>
