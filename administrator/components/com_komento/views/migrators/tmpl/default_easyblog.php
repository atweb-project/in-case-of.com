...
$easyblogObj = $componentHelper->getComponentObject( 'com_easyblog' );
		...
		<td width="50%" valign="top">
			...
			<legend><?php echo JText::_( 'COM_KOMENTO_MIGRATORS_LAYOUT_MAIN' ); ?></legend>
				<table class="migrator-options admintable">
					<tr>
						<td class="key"><span><?php echo JText::_( 'COM_KOMENTO_MIGRATORS_SELECT_EASYBLOG_CATEGORIES' ); ?></span></td>
...
<?php } else { ?>
<table id="migrator-easyblog" class="noshow adminlist">
	<tr>
		<td><?php echo JText::_( 'COM_KOMENTO_EASYBLOG_NOT_INSTALLED' ); ?></td>
	</tr>
</table>
<?php } ?>
