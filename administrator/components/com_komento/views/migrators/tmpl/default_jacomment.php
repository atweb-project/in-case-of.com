...
if( $componentHelper->isInstalled( 'com_jacomment' ) ) {
$components	= $this->getModel()->getMigrator( 'jacomment' )->getUniqueComponents();
$selection = array();
...
<table id="migrator-jacomment" migrator-type="jacomment" migration-type="component" class="noshow migratorTable">
	<tr>
...
<?php } else { ?>
<table id="migrator-jacomment" class="noshow adminlist">
	<tr>
		<td><?php echo JText::_( 'COM_KOMENTO_JACOMMENT_NOT_INSTALLED' ); ?></td>
	</tr>
</table>
<?php } ?>
