		...
		<td width="50%" valign="top">
			...
			<table class="admintable" cellspacing="1">
				<tbody>
					...
					<!-- Form position -->
					<?php $options = array();
						$options[] = $this->renderOption( '0', 'COM_KOMENTO_SETTINGS_FORM_POSITION_BEFORE' );
						$options[] = $this->renderOption( '1', 'COM_KOMENTO_SETTINGS_FORM_POSITION_AFTER' );
		...
		<td width="50%" valign="top">
			...
			<table class="admintable" cellspacing="1">
				<tbody>
					<!-- Show Name -->
					<?php $options = array();
						$options[] = $this->renderOption( '0', 'COM_KOMENTO_SETTINGS_SHOW_FIELD_OFF' );
						$options[] = $this->renderOption( '1', 'COM_KOMENTO_SETTINGS_SHOW_FIELD_GUEST' );
						$options[] = $this->renderOption( '2', 'COM_KOMENTO_SETTINGS_SHOW_FIELD_ALL' );
			...
			<table class="admintable" cellspacing="1">
				<tbody>
					...
					<!-- Require Name -->
					<?php $options = array();
						$options[] = $this->renderOption( '0', 'COM_KOMENTO_SETTINGS_REQUIRE_FIELD_OFF' );
						$options[] = $this->renderOption( '1', 'COM_KOMENTO_SETTINGS_REQUIRE_FIELD_GUEST' );
						$options[] = $this->renderOption( '2', 'COM_KOMENTO_SETTINGS_REQUIRE_FIELD_ALL' );
