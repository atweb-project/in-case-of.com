...
<div id="submenu-box">
	...
	<div class="m">
		...
		<div class="kmt-component-select">
			...
			?>
			<?php echo JText::_( 'COM_KOMENTO_SETTINGS_SELECT_COMPONENT' ) . ': ' . JHTML::_( 'select.genericlist' , $components , 'test' , 'class="inputbox" onchange="changeComponent(this.value)"' , 'value' , 'text' , $component ); ?>
		</div>
