	...
	<table class="adminlist" cellspacing="1">
		...
		<tbody>
			...
			<tr class="row<?php echo $k; ?>">
				...
				<td><?php echo str_repeat( '|—', $usergroup->depth ); ?> <a href="index.php?option=com_komento&view=acl&layout=form&type=usergroup&id=<?php echo $usergroup->id; ?>"><?php echo $usergroup->title; ?></a></td>
