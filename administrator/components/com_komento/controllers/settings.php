...
class KomentoControllerSettings extends JController
{
	public function apply()
	{
		...
		$redirect	= 'index.php?option=com_komento&view=settings&active=' . $layout . '&activechild=' . $child;
	...
	private function doSave()
	{
		...
		$mainframe->setUserState('com_komento.settings.component', $post['component']);
