...
<div class="clearfix">
	<img id="captcha-image" class="float-l" src="<?php echo KomentoRouterHelper::_( 'index.php?option=com_komento&controller=captcha&task=display&tmpl=component&no_html=1&captcha-id=' . $id );?>" />
