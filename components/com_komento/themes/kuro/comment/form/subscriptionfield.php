...
if( $system->config->get( 'enable_subscription' ) && $system->config->get( 'show_email' ) > 0 && !$system->config->get( 'subscription_auto' ) ) {
	$subscribed = null;
	...
	<span class="<?php if( $subscribed !== null ) echo 'subscribed '; ?>subscribeForm kmt-form-subscription selected">
