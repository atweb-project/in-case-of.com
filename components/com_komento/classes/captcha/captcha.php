...
class KomentoCaptcha extends JObject
{
	public function getHTML()
	{
		...
		$captcha->created	= JFactory::getDate()->toMySQL();
		$captcha->store();
	...
	public function getReloadSyntax()
	{
		...
		$url	= KomentoRouterHelper::_( 'index.php?option=com_komento&controller=captcha&task=display&captcha-id=' . $captcha->id . '&no_html=1&tmpl=component' );
