...
//		}  // Add To Cart Button END
		?>
		<!-- Custom Field Override by Dimitris Kostaras (AtWeb) -->
		<div class="product-fields">
			<div>
			<?php 
			switch ($this->product->virtuemart_product_id) {
				case 3:
					echo "<a href='#certificate' style='cursor:pointer' class='link'> Limited Edition Of 1500 Cabinets <br />
							All Cabinets Come With A Certificate Of Authenticity</a>";
					break;
				case 22:
					echo "<a href='#certificate' style='cursor:pointer' class='link'> Limited Edition Of 1589 Cabinets <br />
							All Cabinets Come With A Certificate Of Authenticity</a>";
					break;
				case 19:
					echo "<a href='#certificate' style='cursor:pointer' class='link'> Limited Edition Of 1589 Cabinets <br />
				...
				case 18:
					...
					break;
				case 21:
					echo "<a href='#certificate' style='cursor:pointer' class='link'> Limited Edition Of 0066 Cabinets <br />
							All Cabinets Come With A Certificate Of Authenticity</a>";
					break;

			}
					//if ($this->product->virtuemart_product_id == 18) {
					//	echo "yes";
					//} else {
				//				echo "no";
					//} 
			...
			<div id="certificate">
				<img src="images/stories/virtuemart/product/cert_auth.jpg" alt="certificate" />
			</div>
			</div>
			<a href="#handmade" style="cursor:pointer" class="link"> 
				Unique & Hand Made!<br />
	...
	<?php
      ...
      if ($field->display) {
          ...
          <?php
			...
			?>
             <a href="<?php echo $field->display ?>" ><?php echo JText::_($field->custom_title); ?>
             <p>
