...
//Addon function for detecting the country of the visitor
...
<div class="addtocart-area">
	...
	<form method="post" class="product js-recalculate" action="<?php echo JRoute::_ ('index.php'); ?>">
		...
		if (!empty($this->product->customfieldsCart) && visitor_country() != 'United States') {//addon by Atweb for not showing the Led price in USA
			?>
