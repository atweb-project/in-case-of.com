...
if (!empty($this->products)) {
	...
	<!-- Category override by Dimitris Kostaras (AtWeb) -->
<!-- 
...
<h1><?php echo $this->category->category_name; ?></h1>
	...
	<?php
		...
		// Show Products
		?>
		<!-- cat_pro_view new class override for width by Dimitris Kostaras (Atweb) -->
		<div class="product floatleft<?php echo $Browsecellwidth . $show_vertical_separator ?> cat_pro_view">
			<div class="spacer">
				...
				<div class="width70 floatright">
					...
					<h2 style="text-align:left;"><?php echo JHTML::link ($product->link, $product->product_name); ?></h2>
